...
{
    [Route("api/functionSecurity")]
    public class FunctionSecurityController : BaseApiController
    {
        ...
        public FunctionSecurityController(IMetadataManager iMetadataManager,IManagerEntitySecurity managerEntitySecurity,IManagerRole managerRole,
        ...
        public IActionResult Post(string entityname,[FromBody] EntitySecurityInfo entitySecurity)
        {
            ...
            {   
                ...
                _securityCacheManager.Clear(TenantCode,UserId,EntityCacheType.Function);

...
{
    public class BatchItemsProcessed24Hours : ICustomServerFieldExecution
    {
        ...
        public CustomFieldExecutionMessage Execute(CustomFieldExecutionPayload payloadObj)
        {
            ...
            var queuedCount=_managerNacthItem.BatchItemByStatus(tenantId,payloadObj.Id,BatchItemTypeEnum.Processed24hours);

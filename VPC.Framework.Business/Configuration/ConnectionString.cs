...
namespace VPC.Framework.Business.Configuration {
  ...
  public sealed class AlternativeLanguage {
    public static string GetAltLanguageKey () {
      string altLanguage = "en-US";
      return altLanguage;
    }
    public static string GetAltLanguage () {
      string altLanguage = "Eng";
      return altLanguage;
    }

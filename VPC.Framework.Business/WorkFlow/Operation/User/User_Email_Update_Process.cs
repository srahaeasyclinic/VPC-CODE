...
namespace VPC.Framework.Business.WorkFlow.Operation.User
{
    ...
    [Operation(OperationName = Operations.Update,Context = WorkFlowEngine._user,
     Key = "User_Email_Update_Process", Id = "4D8F9B17-341F-45E7-9CB7-5ED8ACE4F42E",ProcessType=WorkFlowProcessType.Process)]
    public class User_Email_Update_Process : IOperation
    {

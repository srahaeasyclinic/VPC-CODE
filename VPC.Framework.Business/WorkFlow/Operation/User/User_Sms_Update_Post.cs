...
namespace VPC.Framework.Business.WorkFlow.Operation.User
{
    ...
    [Operation(OperationName = Operations.Update,Context = WorkFlowEngine._user,
     Key = "User_Sms_Update_Post", Id = "9C9F7089-48BA-4311-8E14-8A0C4FB06ECA",ProcessType=WorkFlowProcessType.PostProcess)]
    public class User_Sms_Update_Post : IOperation
    {

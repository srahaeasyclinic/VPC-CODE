...
namespace VPC.Framework.Business.WorkFlow.Operation.User
{
    ...
    [Operation(OperationName = Operations.Update,Context = WorkFlowEngine._user,
     Key = "User_Email_Update_Pre", Id = "7D4268D7-E4DA-4414-87D9-4376F9308489",ProcessType=WorkFlowProcessType.PreProcess)]
    public class User_Email_Update_Pre : IOperation
    {

...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [PluralName("Security functions")]
    [FixedValue]
    [CustomizeValue()]
    [Standard]
    public class SecurityFunction : ComplexPicklist
    {
        [NonQueryable]
        [ColumnName("[TenantId]")]
        [NotNull]
        ...
        [NonQueryable]
        [NotNull]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.SecurityFunction);
        ...
        [AccessibleLayout((int)LayoutType.View, (int)LayoutType.List, (int)LayoutType.Form)]
        [DisplayName("PickList value for security function")]
        public PickListValueForSecurityFunction PickListValueForSecurityFunction { get; set; }
    }
}
...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [DisplayName("Workcenter sub type")]
    [PluralName("Workcenter sub types")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class WorkcenterSubType : SimplePicklist
    {
        [AccessibleLayout((int)LayoutType.View, (int)LayoutType.List)]
        [DefaultValue("10023")]
        [ColumnName("[PickListId]")]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.WorkcenterSubType);

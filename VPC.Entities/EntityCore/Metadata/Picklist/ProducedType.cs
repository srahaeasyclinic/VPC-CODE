...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [PluralName("Produced types")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class ProducedType : SimplePicklist
    {
        [DefaultValue("10039")]
        [ColumnName("[PickListId]")]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.ProducedType);

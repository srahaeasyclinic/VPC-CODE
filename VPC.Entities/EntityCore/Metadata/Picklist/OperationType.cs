...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [PluralName("Operation types")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class OperationType : SimplePicklist
    {
        ...
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.OperationType);

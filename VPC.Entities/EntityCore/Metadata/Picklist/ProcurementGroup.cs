...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [PluralName("Procurement groups")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class ProcurementGroup : ComplexPicklist
    {
        ...
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.ProcurementGroup);

...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [PluralName("Subscription groups")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class SubscriptionGroup : SimplePicklist
    {
        [DefaultValue("10016")]
        [ColumnName("[PickListId]")]
        [NonQueryable]
        [NotNull]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.SubscriptionGroup);

...
namespace VPC.Entities.EntityCore.Metadata.Picklist
{
    ...
    [DisplayName("Application menu group")]
    [PluralName("Application menu groups")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class ApplicationMenuGroup : SimplePicklist
    {
        [NonQueryable]
        [ColumnName("[TenantId]")]
        [NotNull]
        ...
        [AccessibleLayout((int)LayoutType.View, (int)LayoutType.List, (int)LayoutType.Form)]
        [DisplayName("PickList value for Application menu group")]

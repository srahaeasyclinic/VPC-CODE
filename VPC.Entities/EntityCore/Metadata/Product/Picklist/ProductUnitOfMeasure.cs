...
namespace VPC.Entities.EntityCore.Metadata.Product.Picklist
{
    ...
    [PluralName("Unit of measures")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class ProductUnitOfMeasure : SimplePicklist //HierarchyPicklist<ProductType>
    {
        [DefaultValue("10066")]
        [ColumnName("[PickListId]")]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.ProductUnitOfMeasure);

...
namespace VPC.Entities.EntityCore.Metadata.Product.Picklist
{
    ...
    [PluralName("Lock codes")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class ProductLockCode : SimplePicklist //HierarchyPicklist<ProductType>
    {
        [DefaultValue("10060")]
        [ColumnName("[PickListId]")]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.ProductLockCode);

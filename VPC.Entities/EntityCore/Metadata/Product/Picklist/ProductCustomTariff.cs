...
namespace VPC.Entities.EntityCore.Metadata.Product.Picklist
{
    ...
    [PluralName("Customs tariff")]
    [SupportWorkflow(false)]
    [CustomizeValue()]
    [Standard]
    public class ProductCustomTariff : SimplePicklist //HierarchyPicklist<ProductType>
    {
        [DefaultValue("10062")]
        [ColumnName("[PickListId]")]
        public override PicklistContext PicklistContext => new PicklistContext(PicklistType.ProductCustomTariff);
